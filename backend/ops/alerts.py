...
KIND_HELP = {
    ...
    "upstox_token_expired": "Upstox rejected the access token. Log in to Upstox, put the new token in UPSTOX_ANALYTICS_TOKEN, restart. Until then daily bars come from the fallback.",
