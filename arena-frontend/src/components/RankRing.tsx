...
export function RankRing({ rank, band, size = 96, stroke = 9, showWord = true }: {
  ...
  return (
    <div role="img" aria-label={`Buy Rank ${rank} out of 100, ${s.word}`}
      ...
      <div style={{ position: "absolute", inset: 0, display: "grid", placeItems: "center", textAlign: "center" }}>
        <div>
          <div className="tnum" style={{ fontFamily: "var(--font-display)", fontWeight: 800, fontSize, lineHeight: 1, color: "var(--text)" }}>
            {rank}
          </div>
          {showWord && (
